    ...
    <div className="border border-gray-300 p-6 pb-10 rounded-2xl shadow-lg">
      <form className="flex flex-col gap-8 w-1/2 ml-auto mr-auto pt-4">
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="email" className="flex-1 text-base">Email</label>
          <input
            type="email"
            id="email"
            name="email"
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="password" className="flex-1 text-base">Password</label>
          <input
            type="password"
            id="password"
            name="password"
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="passwordConfirm" className="flex-1 text-base">Confirm Password</label>
          <input
            type="password"
            id="passwordConfirm"
